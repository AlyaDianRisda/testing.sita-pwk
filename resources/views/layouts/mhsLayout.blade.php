...
<body>
    <div class="sidebar sidebar-light sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x2.Homepage') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x2.PeriodeTA') }}">
                    <svg class="nav-icon text-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x2.TopikTA') }}">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-library') }}">
                        </use>
                    </svg>
                    Daftar Topik Dosen</a>
            </li>
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.TugasAkhir-1') }}"><span class="nav-icon"><span
                                    class=""></span></span>Pengajuan Proposal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.TugasAkhir-2') }}"><span class="nav-icon"><span
            ...
            <li class="nav-group">
                <a class="nav-link nav-group-toggle" href="#">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-paper-plane') }}">
                        </use>
                    </svg>
                    Pendaftaran Sidang</a>
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.PendaftaranSidang-1') }}"><span class="nav-icon"><span
                                    class=""></span></span>Seminar Proposal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.PendaftaranSidang-2') }}"><span class="nav-icon"><span
                                    class=""></span></span>Seminar Pembahasan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.PendaftaranSidang-3') }}"><span class="nav-icon"><span
                                    class=""></span></span>Sidang Ujian</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x2.PendaftaranSidang-4') }}"><span class="nav-icon"><span
                                    class=""></span></span>Nilai dan Hasil</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x2.JadwalSidang') }}">
                    <svg class="nav-icon text-dark">
            ...
            <div class="container-fluid px-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb my-0">
                        <li class="breadcrumb-item accent-text">Mahasiswa Panel</li>
                    </ol>
                </nav>
            </div>
        </header>
