...
<body>
    <div class="sidebar sidebar-light sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x0.Homepage') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x0.PeriodeTA') }}">
                    <svg class="nav-icon text-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x0.KelolaPOB') }}">
                    <svg class="nav-icon text-dark">
            ...
            <li class="nav-group">
                <a class="nav-link nav-group-toggle" href="#">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-view-module') }}">
                        </use>
                    </svg>
                    Rekapitulasi TA</a>
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.RekapitulasiTA-1') }}"><span class="nav-icon"><span
                                    class=""></span></span>Monitoring Proposal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.RekapitulasiTA-2') }}"><span class="nav-icon"><span
                                    class=""></span></span>Monitoring Umum</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.RekapitulasiTA-3') }}"><span class="nav-icon"><span
                                    class=""></span></span>Rekapitulasi Diarsipkan</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x0.PlottingSidang') }}">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-pin') }}">
                        </use>
                    </svg>
                    Plotting Sidang</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('x0.KelolaPenilaian') }}">
                    <svg class="nav-icon text-dark">
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.DataPengguna-1') }}"><span class="nav-icon"><span
                                    class=""></span></span> Administrator</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.DataPengguna-2') }}"><span class="nav-icon"><span
                                    class=""></span></span> Dosen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('x0.DataPengguna-3') }}"><span class="nav-icon"><span
                                    class=""></span></span>
                            Mahasiswa</a>
                    </li>
                </ul>
            ...
            <div class="container-fluid px-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb my-0">
                        <li class="breadcrumb-item accent-text">Koordinator Panel</li>
                    </ol>
                </nav>
            </div>
        </header>
