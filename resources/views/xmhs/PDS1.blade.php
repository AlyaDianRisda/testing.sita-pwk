...
@section('content')
    <div class="card mb-4 py-3">
        ...
        <span class="fw-semibold fs-5 mb-1">Form Pendaftaran Seminar Proposal</span>
        <hr />

        <div class="row">

            <form id="formSempro" action="{{ route('x2.PendaftaranSidang1-form1') }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table1').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('x2.PendaftaranSidang1-json1') }}',
                columns: [{
                        data: 'topik',
                        name: 'topik'
                    },
