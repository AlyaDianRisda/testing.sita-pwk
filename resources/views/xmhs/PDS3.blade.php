...
@section('content')
    <div class="card mb-4 py-3">
        ...
        <span class="fw-semibold fs-5 mb-1">Form Pendaftaran Sidang Ujian</span>
        <hr />

        <div class="row">

            <form id="formSidu" action="{{ route('x2.PendaftaranSidang3-form1') }}" method="POST"
                ...
                <div class="row g-2">
                    ...
                    <!-- FORM INPUT -->
                    <div class="col-12">
                        <label for="formFile2" class="form-label">Laporan Akhir</label>
                        <div class="input-group mb-3">
                    ...
                    <div class="col-12">
                        <label for="formFile2" class="form-label">Berita Acara</label>
                        <div class="input-group mb-3">
                    ...
                    <div class="col-12">
                        <label for="formFile2" class="form-label">Lembar Pengesahan</label>
                        <div class="input-group mb-3">
            ...
            <table class="table table-bordered table-hover" id="table1">
                <thead>
                    <tr class="table-light">
                        ...
                        <th scope="col">Logbook Lengkap</th>
